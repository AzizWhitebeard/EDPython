...
def Jugg():
    ...
    while True:
        ...
        inLobby = MI.locateCenterOnScreen('images/chatLog.png', confidence = 0.7, region = (1331, 815, 1369, 850))
        if(inLobby):

                #WAR CRAP Ughhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh
            ...
            inLobbyy = MI.locateCenterOnScreen('images/chatLog.png', confidence = 0.7, region = (1331, 815, 1369, 850))
            while(inLobbyy):
                MI.click(1511, 831)
                time.sleep(0.5)
                inLobbyy = MI.locateCenterOnScreen('images/chatLog.png', confidence = 0.7, region = (1331, 815, 1369, 850))
